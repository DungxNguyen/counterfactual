...
from data_utils import get_state_train_data_flu, create_window_seqs, get_county_train_data, counties, get_age_group_train_data
...
class MetapopulationSEIRM:
    ...
    def step(self, t, values, seed_status):
        """
